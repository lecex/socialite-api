...
func (c *usersService) SelfBind(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Users.SelfBind", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *usersService) SelfUnbind(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Users.SelfUnbind", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterUsersHandler(s server.Server, hdlr UsersHandler, opts ...server.HandlerOption) error {
	type users interface {
		...
		SelfBind(ctx context.Context, in *Request, out *Response) error
		SelfUnbind(ctx context.Context, in *Request, out *Response) error
	}
	type Users struct {
		users
	}
...
func (h *usersHandler) SelfBind(ctx context.Context, in *Request, out *Response) error {
	return h.UsersHandler.SelfBind(ctx, in, out)
}

func (h *usersHandler) SelfUnbind(ctx context.Context, in *Request, out *Response) error {
	return h.UsersHandler.SelfUnbind(ctx, in, out)
}
